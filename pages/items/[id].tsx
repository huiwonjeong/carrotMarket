      ...
      <div className="mb-8">
        ...
        <div className="mt-5">
          ...
          <div className="flex items-center justify-between space-x-2">
            <button className="flex-1  bg-orange-400 hover:bg-orange-500 text-white border py-2 px-2 rounded-md border-transparent shadow-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-400 focus:outline-none">
              Talk to seller
            </button>
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          {[1, 2, 3, 4, 5, 6].map((_, i) => (
            <div key={i}>
              ...
              <span className="text-xs text-gray-900">$6</span>
            </div>
          ))}
        </div>
      </div>
