...
const Upload: NextPage = () => {
  return (
    <div className="px-10 py-16">
      <div>
        <div>
          <label className="w-full text-gray-600 hover:text-orange-400 hover:cursor-pointer hover:border-orange-400 flex items-center justify-center border-2 border-dashed border-gray-300 py-48 rounded-md ">
            <svg
              className="h-12 w-12"
              stroke="currentColor"
              fill="none"
